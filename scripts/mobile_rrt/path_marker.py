...
class RRTPath:
    ...
    def __init__(self):
        ...
        self.marker_pub = rospy.Publisher("rrt_path", Marker, queue_size=10)
        ...
        self.node.scale.x = 0.015
        self.node.scale.y = 0.015
        self.node.scale.z = 0.015
        self.node.color.r = 1.0
        self.node.color.g = 0.2
        ...
        self.path.scale.z = 0.02
        self.path.scale.x = 0.02
        self.path.scale.y = 0.02
        self.path.color.r = 1.0
        self.path.color.g = 1.0
        self.path.color.b = 0.0
        self.path.color.a = 1.0

        with open("../../data/coordinates.dat", 'r') as f:
            for line in f:
                line = line.rstrip("\n")
                xyz = line.split("\t")[:-1]
                p = Point()
