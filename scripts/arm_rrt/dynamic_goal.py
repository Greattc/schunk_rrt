...
class DynamicRobotMarker:
    ...
    def __init__(self):
        ...
        self.robot_marker.pose.position.x = -0.4
        self.robot_marker.pose.position.y = 0.6
        self.robot_marker.pose.position.z = 0.3
        ...
        #The initial position of the MR
        self.goal_marker.pose.position.x = 0.496475
        self.goal_marker.pose.position.y = 0.554664
        self.goal_marker.pose.position.z = 0.293018
