...
class ObstacleMarker:
    ...
    def __init__(self):
        ...
        self.marker_pub = rospy.Publisher("cube_marker2", Marker, queue_size=1)

        self.obstacle_marker = Marker()
        self.obstacle_marker.type = Marker.CUBE
        self.obstacle_marker.header.frame_id = "/world"
        self.obstacle_marker.ns = "rrt"
        self.obstacle_marker.id = 10
        ...
        self.obstacle_marker.scale.z = 0.05
        ...
        self.obstacle_marker.pose.position.x = 0.4
        self.obstacle_marker.pose.position.y = -0.3
        self.obstacle_marker.pose.position.z = 0.9
