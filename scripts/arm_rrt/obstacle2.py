...
class ObstacleMarker:
    ...
    def __init__(self):
        ...
        self.marker_pub = rospy.Publisher("cube_marker", Marker, queue_size=1)
        ...
        self.obstacle_marker.pose.position.x = 0.6
        self.obstacle_marker.pose.position.y = -0.2
        self.obstacle_marker.pose.position.z = 0.7
